 ...
 * Build date: 2026-08-04T15:26:35.825Z
 */
...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), xn = (e) => e.startsWith("onUpdate:"), le = Object.assign, Tn = (e, t) => {
  const s = e.indexOf(t);
  s > -1 && e.splice(s, 1);
}, Fi = Object.prototype.hasOwnProperty, z = (e, t) => Fi.call(e, t), H = Array.isArray, Ot = (e) => js(e) === "[object Map]", oo = (e) => js(e) === "[object Set]", Y = (e) => typeof e == "function", ae = (e) => typeof e == "string", pt = (e) => typeof e == "symbol", oe = (e) => e !== null && typeof e == "object", io = (e) => (oe(e) || Y(e)) && Y(e.then) && Y(e.catch), lo = Object.prototype.toString, js = (e) => lo.call(e), Hi = (e) => js(e).slice(8, -1), Ds = (e) => js(e) === "[object Object]", Pn = (e) => ae(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, Xt = /* @__PURE__ */ Mn(
...
), ao = Us((e) => e.charAt(0).toUpperCase() + e.slice(1)), Js = Us(
  (e) => e ? `on${ao(e)}` : ""
...
const Ji = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", Zi = /* @__PURE__ */ Mn(Ji);
function uo(e) {
  return !!e || e === "";
}
const fo = (e) => !!(e && e.__v_isRef === !0), X = (e) => ae(e) ? e : e == null ? "" : H(e) || oe(e) && (e.toString === lo || !Y(e.toString)) ? fo(e) ? X(e.value) : JSON.stringify(e, ho, 2) : String(e), ho = (e, t) => fo(t) ? ho(e, t.value) : Ot(t) ? {
...
} : pt(t) ? Qs(t) : oe(t) && !H(t) && !Ds(t) ? String(t) : t, Qs = (e, t = "") => {
  var s;
  return (
...
class jn {
  ...
  track(t) {
    ...
    if (s === void 0 || s.sub !== $)
      s = this.activeLink = new $i($, this), $.deps ? (s.prevDep = $.depsTail, $.depsTail.nextDep = s, $.depsTail = s) : $.deps = $.depsTail = s, Ro(s);
...
const sl = /* @__PURE__ */ Mn("__proto__,__v_isRef,__isVue"), vo = new Set(
...
class Co {
  ...
  get(t, s, n) {
    ...
    if ((pt(s) ? vo.has(s) : sl(s)) || (r || pe(t, "get", s), o))
      return l;
    if (ge(l)) {
      const u = i && Pn(s) ? l : l.value;
...
class Eo extends Co {
  ...
  set(t, s, n, r) {
    ...
    if (!this._isShallow) {
      const u = Rt(o);
      if (!Le(n) && !Rt(n) && (o = J(o), n = J(n)), !H(t) && ge(o) && !ge(n))
        return u || (o.value = n), !0;
    }
    const i = H(t) && Pn(s) ? Number(s) < t.length : z(t, s), l = Reflect.set(
      t,
      s,
      n,
      ge(t) ? t : r
    );
    return t === J(r) && (i ? dt(n, o) && nt(t, "set", s, n) : nt(t, "add", s, n)), l;
  }
  deleteProperty(t, s) {
    const n = z(t, s);
    t[s];
  ...
  has(t, s) {
    ...
    return (!pt(s) || !vo.has(s)) && pe(t, "has", s), n;
  }
  ownKeys(t) {
    return pe(
      t,
...
function al(e, t, s) {
  return function(...n) {
    const r = this.__v_raw, o = J(r), i = Ot(o), l = e === "entries" || e === Symbol.iterator && i, u = e === "keys" && i, c = r[e](...n), a = s ? hn : t ? mn : be;
    return !t && pe(
      o,
      "iterate",
      u ? dn : wt
...
function cl(e, t) {
  const s = {
    ...
    forEach(r, o) {
      const i = this, l = i.__v_raw, u = J(l), c = t ? hn : e ? mn : be;
  ...
  return le(
    ...
    e ? {
      ...
      set(r, o) {
        !t && !Le(o) && !Rt(o) && (o = J(o));
        const i = J(this), { has: l, get: u } = gs(i);
        let c = l.call(i, r);
      ...
      delete(r) {
        const o = J(this), { has: i, get: l } = gs(o);
        let u = i.call(o, r);
        u || (r = J(r), u = i.call(o, r)), l && l.call(o, r);
        const c = o.delete(r);
...
function Zt(e) {
  return Rt(e) ? Zt(e.__v_raw) : !!(e && e.__v_isReactive);
}
function Rt(e) {
...
function yl(e) {
  return !z(e, "__v_skip") && Object.isExtensible(e) && co(e, "__v_skip", !0), e;
}
...
class wl {
  ...
  set value(t) {
    const s = this._rawValue, n = this.__v_isShallow || Le(t) || Rt(t);
...
function To(e) {
  return Zt(e) ? e : new Proxy(e, Al);
}
class Rl {
  constructor(t, s, n) {
    this.fn = t, this.setter = s, this._value = void 0, this.dep = new jn(this), this.__v_isRef = !0, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = ts - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !s, this.isSSR = n;
  }
  /**
   * @internal
   */
...
function vl(e, t, s = !1) {
  let n, r;
  return Y(e) ? n = e : (n = e.get, r = e.set), new Rl(n, r, s);
}
...
function El(e, t, s = ee) {
  const { immediate: n, deep: r, once: o, scheduler: i, augmentJob: l, call: u } = s, c = (R) => r ? R : Le(R) || r === !1 || r === 0 ? ft(R, 1) : ft(R);
  let a, f, h, g, m = !1, b = !1;
  if (ge(e) ? (f = () => e.value, m = Le(e)) : Zt(e) ? (f = () => c(e), m = !0) : H(e) ? (b = !0, m = e.some((R) => Zt(R) || Le(R)), f = () => e.map((R) => {
    if (ge(R))
      return R.value;
    if (Zt(R))
      return c(R);
  ...
  return l && l(T), a = new po(f), a.scheduler = i ? () => i(T, !1) : T, g = (R) => Cl(R, !1, a), h = a.onStop = () => {
    const R = Ms.get(a);
    if (R) {
      if (u)
        u(R, 4);
...
function xl(e) {
  H(e) ? kt.push(...e) : ct && e.id === -1 ? ct.splice(Pt + 1, 0, e) : e.flags & 1 || (kt.push(e), e.flags |= 1), Oo();
}
function dr(e, t, s = Je + 1) {
  for (; s < we.length; s++) {
    const n = we[s];
    if (n && n.flags & 2) {
      if (e && n.id !== e.uid)
...
function No(e) {
  try {
    ...
    Je = -1, we.length = 0, ko(), xs = null, (we.length || kt.length) && No();
  }
}
let Qe = null, jo = null;
function Ts(e) {
  const t = Qe;
  return Qe = e, jo = e && e.type.__scopeId || null, t;
}
...
const Pl = Symbol("_vte"), Il = (e) => e.__isTeleport, Ol = Symbol("_leaveCb");
function Vn(e, t) {
...
function Qt(e, t, s, n, r = !1) {
  ...
  const o = n.shapeFlag & 4 ? Kn(n.component) : n.el, i = r ? null : o, { i: l, r: u } = e, c = t && t.r, a = l.refs === ee ? l.refs = {} : l.refs, f = l.setupState, h = J(f), g = f === ee ? ro : (m) => z(h, m);
  if (c != null && c !== u) {
    if (hr(t), ae(c))
...
function Lo(e, t, s = Ae) {
  ...
  if (Fs(t, n, s), s) {
    let r = s.parent;
    for (; r && r.parent; )
      Uo(r.parent.vnode) && jl(n, t, s, r), r = r.parent;
  }
}
function jl(e, t, s, n) {
  const r = Fs(
...
const Wl = Symbol.for("v-ndc"), gn = (e) => e ? ri(e) ? Kn(e) : gn(e.parent) : null, _t = (
...
), en = (e, t) => e !== ee && !e.__isScriptSetup && z(e, t), Gl = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
  ...
  set({ _: e }, t, s) {
    ...
    return en(r, t) ? (r[t] = s, !0) : n !== ee && z(n, t) ? (n[t] = s, !0) : z(e.props, t) || t[0] === "$" && t.slice(1) in e ? !1 : (o[t] = s, !0);
  },
  has({
    _: { data: e, setupState: t, accessCache: s, ctx: n, appContext: r, propsOptions: o, type: i }
  }, l) {
    let u, c;
    return !!(s[l] || e !== ee && l[0] !== "$" && z(e, l) || en(t, l) || (u = o[0]) && z(u, l) || z(n, l) || z(_t, l) || z(r.config.globalProperties, l) || (c = i.__cssModules) && c[l]);
  },
...
function zl(e) {
  ...
  if (yn = !0, o)
    for (const q in o) {
      const W = o[q], We = Y(W) ? W.bind(s, s) : Y(W.get) ? W.get.bind(s, s) : qe, St = !Y(W) && Y(W.set) ? W.set.bind(s) : qe, he = Rs({
        get: We,
        set: St
      });
  ...
  if (K(Dl, f), K(Yn, h), K(Ul, g), K(Ll, m), K(kl, b), K(Nl, A), K(Yl, Ie), K(Vl, re), K(Hl, te), K(Bl, U), K(Wn, R), K(Fl, $e), H(Ve))
    if (Ve.length) {
  ...
  L && e.render === qe && (e.render = L), at != null && (e.inheritAttrs = at), et && (e.components = et), Ye && (e.directives = Ye), $e && Do(e);
}
...
function Fo(e) {
  ...
  return l ? u = l : !r.length && !s && !n ? u = t : (u = {}, r.length && r.forEach(
    (c) => Is(u, c, i, !0)
  ), Is(u, t, i)), oe(t) && o.set(t, u), u;
}
function Is(e, t, s, n = !1) {
  const { mixins: r, extends: o } = t;
  o && Is(e, o, s, !0), r && r.forEach(
    (i) => Is(e, i, s, !0)
  );
  for (const i in t)
    if (!(n && i === "expose")) {
...
function ql(e, t) {
  return function(n, r = null) {
    ...
    const c = o.app = {
      ...
      use(a, ...f) {
        return i.has(a) || (a && Y(a.install) ? (i.add(a), a.install(c, ...f)) : Y(a) && (i.add(a), a(c, ...f))), c;
      },
      mixin(a) {
      ...
      mount(a, f, h) {
        if (!u) {
          ...
          return g.appContext = o, h === !0 ? h = "svg" : h === !1 && (h = void 0), e(g, a, h), u = !0, c._container = a, a.__vue_app__ = c, Kn(g.component);
        }
      },
      onUnmount(a) {
        l.push(a);
...
const Vo = {}, Yo = () => Object.create(Vo), Wo = (e) => Object.getPrototypeOf(e) === Vo;
...
function $l(e, t, s, n) {
  ...
  if (
    ...
    for (const f in l)
      ...
      ((a = ke(f)) === f || !z(t, a))) && (u ? s && // for camelCase
...
function Go(e, t, s, n) {
  ...
  if (t)
    for (let u in t) {
      ...
      const c = t[u];
      let a;
      r && z(r, a = De(u)) ? !o || !o.includes(a) ? s[a] = c : (l || (l = {}))[a] = c : Hs(e.emitsOptions, u) || (!(u in n) || c !== n[u]) && (n[u] = c, i = !0);
    }
  if (o) {
    const u = J(s), c = l || ee;
...
function wn(e, t, s, n, r, o) {
  ...
  if (i != null) {
    ...
    if (l && n === void 0) {
      const u = i.default;
      if (i.type !== Function && !i.skipFactory && Y(u)) {
...
function zo(e, t, s = !1) {
  ...
  if (H(o))
    ...
    for (const a in o) {
      const f = De(a);
      if (br(f)) {
        const h = o[a], g = i[f] = H(h) || Y(h) ? { type: h } : le({}, h), m = g.type;
        let b = !1, A = !0;
        if (H(m))
          for (let S = 0; S < m.length; ++S) {
            const U = m[S], T = Y(U) && U.name;
            if (T === "Boolean") {
              b = !0;
              break;
            } else T === "String" && (A = !1);
...
const Gn = (e) => e === "_" || e === "_ctx" || e === "$stable", zn = (e) => H(e) ? e.map(Ze) : [Ze(e)], ta = (e, t, s) => {
  if (t._n)
    return t;
  const n = Tl((...r) => zn(t(...r)), s);
  return n._c = !1, n;
}, Xo = (e, t, s) => {
  const n = e._ctx;
  for (const r in e) {
  ...
  if (e.vnode.shapeFlag & 32) {
    const r = t._;
    r ? (Jo(n, t, s), s && co(n, "_", r, !0)) : Xo(t, n);
  } else t && Ko(e, t);
}, na = (e, t, s) => {
  ...
  if (n.shapeFlag & 32) {
    const l = t._;
    l ? s && l === 1 ? o = !1 : Jo(r, t, s) : (o = !t.$stable, Xo(t, r)), i = t;
...
function oa(e, t) {
  ...
  const {
  ...
  } = e, b = (d, p, w, M = null, v = null, C = null, O = void 0, P = null, x = !!p.dynamicChildren) => {
    if (d === p)
      return;
    d && !Yt(d, p) && (M = ms(d), de(d, v, C, !0), d = null), p.patchFlag === -2 && (x = !1, p.dynamicChildren = null);
    const { type: E, ref: j, shapeFlag: k } = p;
    switch (E) {
      case Vs:
        A(d, p, w, M);
        break;
    ...
    j != null && v ? Qt(j, d && d.ref, C, p || d, !p) : j == null && d && d.ref != null && Qt(d.ref, null, C, d, !0);
  }, A = (d, p, w, M) => {
    if (d == null)
      n(
        p.el = l(p.children),
    ...
    let x, E;
    const { props: j, shapeFlag: k, transition: N, dirs: B } = d;
    if (x = d.el = i(
      d.type,
      C,
      j && j.is,
      j
    ), k & 8 ? a(x, d.children) : k & 16 && Ie(
      d.children,
      x,
      null,
      M,
      ...
      O,
      P
    ), B && mt(d, null, M, "created"), te(x, d, d.scopeId, O, M), j) {
      for (const _ in j)
        _ !== "value" && !Xt(_) && o(x, _, null, j[_], C, M);
      "value" in j && o(x, "value", null, j.value, C), (E = j.onVnodeBeforeMount) && Ke(E, M, d);
    }
    B && mt(d, null, M, "beforeMount");
    const G = ia(v, N);
    G && N.beforeEnter(x), n(x, p, w), ((E = j && j.onVnodeMounted) || G || B) && xe(() => {
      E && Ke(E, M, d), G && N.enter(x), B && mt(d, null, M, "mounted");
    }, v);
  }, te = (d, p, w, M, v) => {
    if (w && g(d, w), M)
    ...
    if (v) {
      let C = v.subTree;
      if (p === C || ei(C.type) && (C.ssContent === p || C.ssFallback === p)) {
        const O = v.vnode;
        te(
          d,
          O,
  ...
  }, Ie = (d, p, w, M, v, C, O, P, x = 0) => {
    for (let E = x; E < d.length; E++) {
      const j = d[E] = P ? ut(d[E]) : Ze(d[E]);
      b(
        null,
        j,
        p,
    ...
    const P = p.el = d.el;
    let { patchFlag: x, dynamicChildren: E, dirs: j } = p;
    x |= d.patchFlag & 16;
    const k = d.props || ee, N = p.props || ee;
    let B;
    if (w && gt(w, !1), (B = N.onVnodeBeforeUpdate) && Ke(B, w, p, d), j && mt(p, d, w, "beforeUpdate"), w && gt(w, !0), (k.innerHTML && N.innerHTML == null || k.textContent && N.textContent == null) && a(P, ""), E ? Ve(
      d.dynamicChildren,
      E,
      P,
      w,
      ...
      if (x & 16)
        at(P, k, N, w, v);
      else if (x & 2 && k.class !== N.class && o(P, "class", null, N.class, v), x & 4 && o(P, "style", k.style, N.style, v), x & 8) {
        const G = p.dynamicProps;
        for (let _ = 0; _ < G.length; _++) {
          const Z = G[_], Re = k[Z], ve = N[Z];
          (ve !== Re || Z === "value") && o(P, Z, Re, ve, v, w);
        }
      }
      x & 1 && d.children !== p.children && a(P, p.children);
    } else !O && E == null && at(P, k, N, w, v);
    ((B = N.onVnodeUpdated) || j) && xe(() => {
      B && Ke(B, w, p, d), j && mt(p, d, w, "updated");
    }, M);
  }, Ve = (d, p, w, M, v, C, O) => {
    for (let P = 0; P < p.length; P++) {
      const x = d[P], E = p[P], j = (
        ...
        !Yt(x, E) || // - In the case of a component, it could contain anything.
    ...
    if (p !== w) {
      ...
      for (const C in w) {
        if (Xt(C)) continue;
        const O = w[C], P = p[C];
        O !== P && C !== "value" && o(d, C, P, O, v, M);
      }
      "value" in w && o(d, "value", p.value, w.value, v);
    }
  }, et = (d, p, w, M, v, C, O, P, x) => {
    const E = p.el = d ? d.el : l(""), j = p.anchor = d ? d.anchor : l("");
    let { patchFlag: k, dynamicChildren: N, slotScopeIds: B } = p;
    B && (P = P ? P.concat(B) : B), d == null ? (n(E, w, M), n(j, w, M), Ie(
      // #10007
  ...
  }, Ye = (d, p, w, M, v, C, O, P, x) => {
    p.slotScopeIds = P, d == null ? p.shapeFlag & 512 ? v.ctx.activate(
      p,
      w,
      M,
      O,
    ...
    const P = d.component = Ma(
      d,
      M,
      v
    );
    if (Uo(d) && (P.ctx.renderer = Ft), Ta(P, !1, O), P.asyncDep) {
      if (v && v.registerDep(P, K, O), !d.el) {
        const x = P.subTree = ce(ht);
    ...
    const P = () => {
      if (d.isMounted) {
        let { next: k, bu: N, u: B, parent: G, vnode: _ } = d;
        {
          const ze = Qo(d);
          if (ze) {
            k && (k.el = _.el, q(d, k, O)), ze.asyncDep.then(() => {
              d.isUnmounted || P();
            });
            return;
          }
        ...
        let Z = k, Re;
        gt(d, !1), k ? (k.el = _.el, q(d, k, O)) : k = _, N && Zs(N), (Re = k.props && k.props.onVnodeBeforeUpdate) && Ke(Re, G, k, _), gt(d, !0);
        const ve = Ar(d), Ge = d.subTree;
        d.subTree = ve, b(
          Ge,
          ve,
          ...
          v,
          C
        ), k.el = ve.el, Z === null && ya(d, ve.el), B && xe(B, v), (Re = k.props && k.props.onVnodeUpdated) && xe(
          () => Ke(Re, G, k, _),
          v
        );
      } else {
        let k;
        const { el: N, props: B } = p, { bm: G, m: _, parent: Z, root: Re, type: ve } = d, Ge = qt(p);
        gt(d, !1), G && Zs(G), !Ge && (k = B && B.onVnodeBeforeMount) && Ke(k, Z, p), gt(d, !0);
        {
          Re.ce && // @ts-expect-error _def is private
          Re.ce._def.shadowRoot !== !1 && Re.ce._injectChildStyle(ve);
          const ze = d.subTree = Ar(d);
          b(
            null,
            ze,
            w,
        ...
        if (_ && xe(_, v), !Ge && (k = B && B.onVnodeMounted)) {
          const ze = p;
          xe(
            () => Ke(k, Z, ze),
            v
        ...
        (p.shapeFlag & 256 || Z && qt(Z.vnode) && Z.vnode.shapeFlag & 256) && d.a && xe(d.a, v), d.isMounted = !0, p = w = M = null;
      }
    };
    d.scope.on();
    const x = d.effect = new po(P);
    d.scope.off();
    const E = d.update = x.run.bind(x), j = d.job = x.runIfDirty.bind(x);
    j.i = d, j.id = d.uid, x.scheduler = () => Hn(j), gt(d, !0), E();
  }, q = (d, p, w) => {
    p.component = d;
    const M = d.vnode.props;
    d.vnode = p, d.next = null, $l(d, p.props, M, w), na(d, p.children, w), ot(), dr(d), it();
  }, W = (d, p, w, M, v, C, O, P, x = !1) => {
    const E = d && d.children, j = d ? d.shapeFlag : 0, k = p.children, { patchFlag: N, shapeFlag: B } = p;
    if (N > 0) {
      if (N & 128) {
        St(
          E,
    ...
    B & 8 ? (j & 16 && Bt(E, v, C), k !== E && a(w, k)) : j & 16 ? B & 16 ? St(
      E,
      k,
      w,
      M,
  ...
  }, We = (d, p, w, M, v, C, O, P, x) => {
    d = d || It, p = p || It;
    const E = d.length, j = p.length, k = Math.min(E, j);
    let N;
    for (N = 0; N < k; N++) {
      const B = p[N] = x ? ut(p[N]) : Ze(p[N]);
      b(
        d[N],
        B,
        w,
  ...
  }, St = (d, p, w, M, v, C, O, P, x) => {
    let E = 0;
    const j = p.length;
    let k = d.length - 1, N = j - 1;
    for (; E <= k && E <= N; ) {
      const B = d[E], G = p[E] = x ? ut(p[E]) : Ze(p[E]);
      if (Yt(B, G))
        b(
          B,
          G,
    ...
    for (; E <= k && E <= N; ) {
      const B = d[k], G = p[N] = x ? ut(p[N]) : Ze(p[N]);
      if (Yt(B, G))
        b(
          B,
          G,
    ...
    if (E > k) {
      ...
      for (E = B; E <= k; E++) {
        ...
        if (Me.key != null)
          ...
          for (Z = G; Z <= N; Z++)
            if (Ht[Z - G] === 0 && Yt(Me, p[Z])) {
              Xe = Z;
              break;
            }
        Xe === void 0 ? de(Me, v, C, !0) : (Ht[Xe - G] = E + 1, Xe >= ze ? ze = Xe : Ge = !0, b(
          Me,
          p[Xe],
          w,
          null,
      ...
      const or = Ge ? la(Ht) : It;
      for (Z = or.length - 1, E = ve - 1; E >= 0; E--) {
        const Me = G + E, Xe = p[Me], ir = p[Me + 1], lr = Me + 1 < j ? (
        ...
        Ht[E] === 0 ? b(
          ...
          P,
          x
        ) : Ge && (Z < 0 || E !== or[Z] ? he(Xe, w, lr, 2) : Z--);
      }
    }
  }, he = (d, p, w, M, v = null) => {
    const { el: C, type: O, transition: P, children: x, shapeFlag: E } = d;
    if (E & 6) {
    ...
    if (M !== 2 && E & 1 && P)
      if (M === 0)
        P.beforeEnter(C), n(C, p, w), xe(() => P.enter(C), v);
      else {
        const { leave: k, delayLeave: N, afterLeave: B } = P, G = () => {
    ...
    if (k === -2 && (v = !1), P != null && (ot(), Qt(P, null, w, d, !0), it()), B != null && (p.renderCache[B] = void 0), j & 256) {
      p.ctx.deactivate(d);
      return;
    }
    const G = j & 1 && N, _ = !qt(d);
    let Z;
    if (_ && (Z = O && O.onVnodeBeforeUnmount) && Ke(Z, p, d), j & 6)
      ps(d.component, w, M);
    else {
      if (j & 128) {
      ...
      G && mt(d, null, p, "beforeUnmount"), j & 64 ? d.type.remove(
        d,
        p,
        w,
        Ft,
      ...
      (C !== ne || k > 0 && k & 64) ? Bt(
        ...
        !1,
        !0
      ) : (C === ne && k & 384 || !v && j & 16) && Bt(x, p, w), M && Mt(d);
    }
    (_ && (Z = O && O.onVnodeUnmounted) || G) && xe(() => {
      Z && Ke(Z, p, d), G && mt(d, null, p, "unmounted");
    }, w);
  }, Mt = (d) => {
    const { type: p, el: w, anchor: M, transition: v } = d;
    if (p === ne) {
      xt(w, M);
      return;
    }
    ...
    const C = () => {
      r(w), v && !v.persisted && v.afterLeave && v.afterLeave();
    };
    if (d.shapeFlag & 1 && v && !v.persisted) {
      const { leave: O, delayLeave: P } = v, x = () => O(w, C);
      P ? P(d.el, C, x) : x();
    } else
      C();
  }, xt = (d, p) => {
    ...
    const { bum: M, scope: v, job: C, subTree: O, um: P, m: x, a: E } = d;
    wr(x), wr(E), M && Zs(M), v.stop(), C && (C.flags |= 8, de(O, d, p, w)), P && xe(P, p), xe(() => {
      d.isUnmounted = !0;
    }, p);
  }, Bt = (d, p, w, M = !1, v = !1, C = 0) => {
    ...
    const p = h(d.anchor || d.el), w = p && p[Pl];
    return w ? h(w) : p;
  };
  let Ks = !1;
  const rr = (d, p, w) => {
...
function Zo(e, t, s = !1) {
  ...
  if (H(n) && H(r))
    for (let o = 0; o < n.length; o++) {
      const i = n[o];
      let l = r[o];
      l.shapeFlag & 1 && !l.dynamicChildren && ((l.patchFlag <= 0 || l.patchFlag === 32) && (l = r[o] = ut(r[o]), l.el = i.el), !s && l.patchFlag !== -2 && Zo(i, l)), l.type === Vs && // avoid cached text nodes retaining detached dom nodes
...
const fa = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${De(t)}Modifiers`] || e[`${ke(t)}Modifiers`];
function da(e, t, ...s) {
  ...
  let l, u = n[l = Js(t)] || // also try camelCase event handler (#2249)
  n[l = Js(De(t))];
  !u && o && (u = n[l = Js(ke(t))]), u && _e(
    u,
    e,
    6,
    r
...
function Hs(e, t) {
  return !e || !Ns(t) ? !1 : (t = t.slice(2).replace(/Once$/, ""), z(e, t[0].toLowerCase() + t.slice(1)) || z(e, ke(t)) || z(e, t));
}
function Ar(e) {
  const {
    type: t,
  ...
  try {
    ...
    es.length = 0, Bs(R, e, 1), S = ce(ht);
  }
  let T = S;
  if (U && b !== !1) {
    const R = Object.keys(U), { shapeFlag: L } = T;
    R.length && L & 7 && (o && R.some(xn) && (U = ma(
      U,
      o
    )), T = jt(T, U, !1, !0));
  }
  return s.dirs && (T = jt(T, null, !1, !0), T.dirs = T.dirs ? T.dirs.concat(s.dirs) : s.dirs), s.transition && Vn(T, s.transition), S = T, Ts(A), S;
}
const pa = (e) => {
  let t;
  for (const s in e)
...
function wa() {
  es.pop(), Pe = es[es.length - 1] || null;
}
let rs = 1;
function vr(e, t = !1) {
  rs += e, e < 0 && Pe && t && (Pe.hasOnce = !0);
}
function ti(e) {
  return e.dynamicChildren = rs > 0 ? Pe || It : null, wa(), rs > 0 && Pe && Pe.push(e), e;
}
...
const ni = ({ key: e }) => e ?? null, As = ({
  ...
  ref_key: t,
  ref_for: s
}) => (typeof e == "number" && (e = "" + e), e != null ? ae(e) || ge(e) || Y(e) ? { i: Qe, r: e, k: t, f: !!s } : e : null);
...
function Aa(e, t = null, s = null, n = 0, r = null, o = !1) {
  if ((!e || e === Wl) && (e = ht), si(e)) {
    ...
    return s && Xn(l, s), rs > 0 && !o && Pe && (l.shapeFlag & 6 ? Pe[Pe.indexOf(e)] = l : Pe.push(l)), l.patchFlag = -2, l;
  }
  if (ka(e) && (e = e.__vccOpts), t) {
    t = Ra(t);
    let { class: l, style: u } = t;
    l && !ae(l) && (t.class = rt(l)), oe(u) && (Fn(u) && !H(u) && (u = le({}, u)), t.style = In(u));
  }
  const i = ae(e) ? 1 : ei(e) ? 128 : Il(e) ? 64 : oe(e) ? 4 : Y(e) ? 2 : 0;
  return I(
    e,
    t,
    s,
...
function jt(e, t, s = !1, n = !1) {
  const { props: r, ref: o, patchFlag: i, children: l, transition: u } = e, c = t ? Ca(r || {}, t) : r, a = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e.type,
    props: c,
...
function Xn(e, t) {
  ...
  if (t == null)
    ...
    if (n & 65) {
      ...
      s = 32;
      const r = t._;
      !r && !Wo(t) ? t._ctx = Qe : r === 3 && Qe && (Qe.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
    }
...
function Er(e, t, s) {
  Y(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : oe(t) && (e.setupState = To(t)), oi(e);
}
function oi(e, t, s) {
  const n = e.type;
...
const Rs = (e, t) => vl(e, t, os), Na = "3.5.24";
/**
...
if (Sr)
  try {
    Rn = /* @__PURE__ */ Sr.createPolicy("vue", {
      createHTML: (e) => e
    });
  } catch {
  }
const ii = Rn ? (e) => Rn.createHTML(e) : (e) => e, ja = "http://www.w3.org/2000/svg", Da = "http://www.w3.org/1998/Math/MathML", st = typeof document < "u" ? document : null, Mr = st && /* @__PURE__ */ st.createElement("template"), Ua = {
  insert: (e, t, s) => {
  ...
  createElement: (e, t, s, n) => {
    const r = t === "svg" ? st.createElementNS(ja, e) : t === "mathml" ? st.createElementNS(Da, e) : s ? st.createElement(e, { is: s }) : st.createElement(e);
...
function Or(e, t, s, n, r, o = Zi(t)) {
  n && t.startsWith("xlink:") ? s == null ? e.removeAttributeNS(Ir, t.slice(6, t.length)) : e.setAttributeNS(Ir, t, s) : s == null || o && !uo(s) ? e.removeAttribute(t) : e.setAttribute(
    t,
    o ? "" : pt(s) ? String(s) : s
  );
}
...
let rn = 0;
const Ja = /* @__PURE__ */ Promise.resolve(), Za = () => rn || (Ja.then(() => rn = 0), rn = Date.now());
function Qa(e, t) {
  const s = (n) => {
    if (!n._vts)
      n._vts = Date.now();
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, _a = (e, t, s, n, r, o) => {
  const i = r === "svg";
  t === "class" ? Ba(e, n, i) : t === "style" ? Ya(e, s, n) : Ns(t) ? xn(t) || Xa(e, t, s, n, o) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : $a(e, t, n, i)) ? (kr(e, t, n), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && Or(e, t, n, i, o, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && (/[A-Z]/.test(t) || !ae(n)) ? kr(e, De(t), n, o, t) : (t === "true-value" ? e._trueValue = n : t === "false-value" && (e._falseValue = n), Or(e, t, n, i));
};
function $a(e, t, s, n) {
  if (n)
    return !!(t === "innerHTML" || t === "textContent" || t in e && Dr(t) && Y(s));
  ...
  _resolveDef() {
    ...
    const t = (n, r = !1) => {
      ...
      if (o && !H(o))
        for (const u in o) {
          const c = o[u];
          (c === Number || c && c.type === Number) && (u in this._props && (this._props[u] = ar(this._props[u])), (l || (l = /* @__PURE__ */ Object.create(null)))[De(u)] = !0);
        }
...
const { toString: ic } = Object.prototype, { getPrototypeOf: Zn } = Object, { iterator: Ys, toStringTag: ci } = Symbol, Ws = /* @__PURE__ */ ((e) => (t) => {
  const s = ic.call(t);
  return e[s] || (e[s] = s.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), Fe = (e) => (e = e.toLowerCase(), (t) => Ws(t) === e), Gs = (e) => (t) => typeof t === e, { isArray: Ut } = Array, Dt = Gs("undefined");
function cs(e) {
...
const ac = Gs("string"), Ee = Gs("function"), fi = Gs("number"), us = (e) => e !== null && typeof e == "object", cc = (e) => e === !0 || e === !1, Cs = (e) => {
  if (Ws(e) !== "object")
    return !1;
  const t = Zn(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(ci in e) && !(Ys in e);
}, uc = (e) => {
  if (!us(e) || cs(e))
    return !1;
  try {
...
const Fr = bc(), Hr = typeof Fr.FormData < "u" ? Fr.FormData : void 0, wc = (e) => {
  let t;
  return e && (Hr && e instanceof Hr || Ee(e.append) && ((t = Ws(e)) === "formdata" || // detect form-data instance
  t === "object" && Ee(e.toString) && e.toString() === "[object FormData]"));
}, Ac = Fe("URLSearchParams"), [Rc, vc, Cc, Ec] = [
  "ReadableStream",
  "Request",
  "Response",
  "Headers"
...
const bt = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, hi = (e) => !Dt(e) && e !== bt;
function vn() {
  const { caseless: e, skipUndefined: t } = hi(this) && this || {}, s = {}, n = (r, o) => {
    if (o === "__proto__" || o === "constructor" || o === "prototype")
      return;
    const i = e && di(s, o) || o;
    Cs(s[i]) && Cs(r) ? s[i] = vn(s[i], r) : Cs(r) ? s[i] = vn({}, r) : Ut(r) ? s[i] = r.slice() : (!t || !Dt(r)) && (s[i] = r);
  };
...
const Mc = (e, t, s, { allOwnKeys: n } = {}) => (fs(
  ...
  for (; t-- > 0; )
    s[t] = e[t];
  return s;
}, kc = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && Zn(Uint8Array)), Nc = (e, t) => {
  ...
  for (; (s = e.exec(t)) !== null; )
    n.push(s);
  return n;
}, Dc = Fe("HTMLFormElement"), Uc = (e) => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function(s, n, r) {
...
function Yc(e) {
  return !!(e && Ee(e.append) && e[ci] === "FormData" && e[Ys]);
}
const Wc = (e) => {
  ...
  return s(e, 0);
}, Gc = Fe("AsyncFunction"), zc = (e) => e && (us(e) || Ee(e)) && Ee(e.then) && Ee(e.catch), mi = ((e, t) => e ? setImmediate : t ? ((s, n) => (bt.addEventListener(
  "message",
  ({ source: r, data: o }) => {
...
}))(`axios@${Math.random()}`, []) : (s) => setTimeout(s))(typeof setImmediate == "function", Ee(bt.postMessage)), Xc = typeof queueMicrotask < "u" ? queueMicrotask.bind(bt) : typeof process < "u" && process.nextTick || mi, Kc = (e) => e != null && Ee(e[Ys]), y = {
  isArray: Ut,
  isArrayBuffer: ui,
  isBuffer: cs,
  isFormData: wc,
...
function zs(e, t, s) {
  ...
  function a(m, b, A) {
    ...
    if (m && !A && typeof m == "object") {
      ...
      else if (y.isArray(m) && Zc(m) || (y.isFileList(m) || y.endsWith(b, "[]")) && (S = y.toArray(m)))
        return b = yi(b), S.forEach(function(T, R) {
          !(y.isUndefined(T) || T === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            i === !0 ? on([b], R, o) : i === null ? b : b + "[]",
            c(T)
          );
        }), !1;
    }
    return Cn(m) ? !0 : (t.append(on(A, b, o), c(m)), !1);
  }
...
let Se = class {
  ...
  set(t, s, n) {
    ...
    function o(l, u, c) {
      ...
      (!f || r[f] === void 0 || c === !0 || c === void 0 && r[f] !== !1) && (Ri(l, u), r[f || u] = Es(l));
    }
...
let hs = class extends D {
   ...
   */
  constructor(t, s, n) {
    super(t ?? "canceled", D.ERR_CANCELED, s, n), this.name = "CanceledError", this.__CANCEL__ = !0;
  }
};
function Ci(e, t, s) {
...
}, Xr = (e) => (...t) => y.asap(() => e(...t)), Ru = me.hasStandardBrowserEnv ? /* @__PURE__ */ ((e, t) => (s) => (s = new URL(s, me.origin), e.protocol === s.protocol && e.host === s.host && (t || e.port === s.port)))(
  new URL(me.origin),
  me.navigator && /(msie|trident)/i.test(me.navigator.userAgent)
) : () => !0, vu = me.hasStandardBrowserEnv ? (
...
const Si = (e) => {
  ...
  return new Promise(function(s, n) {
    ...
    "onloadend" in A ? A.onloadend = S : A.onreadystatechange = function() {
      ...
      A && (n(new D("Request aborted", D.ECONNABORTED, e, A)), A = null);
    }, A.onerror = function(R) {
      const L = R && R.message ? R.message : "Network Error", re = new D(L, D.ERR_NETWORK, e, A);
      re.event = R || null, n(re), A = null;
    ...
    }, o === void 0 && i.setContentType(null), "setRequestHeader" in A && y.forEach(i.toJSON(), function(R, L) {
  ...
  if (t || s) {
    ...
    const o = function(c) {
      if (!r) {
        ...
        n.abort(
          a instanceof D ? a : new hs(a instanceof Error ? a.message : a)
        );
      }
    };
    let i = t && setTimeout(() => {
      i = null, o(new D(`timeout of ${t}ms exceeded`, D.ETIMEDOUT));
    }, t);
    const l = () => {
...
}, Zr = 64 * 1024, { isFunction: ws } = y, Ou = (({ Request: e, Response: t }) => ({
  Request: e,
  Response: t
  ...
  return async (m) => {
    ...
    const je = et && et.unsubscribe && (() => {
      et.unsubscribe();
    });
    let Lt;
    try {
      if (re && c && A !== "get" && A !== "head" && (Lt = await g(Ie, S)) !== 0) {
        let he = new s(b, {
          method: "POST",
          body: S,
          duplex: "half"
        }), de;
        if (y.isFormData(S) && (de = he.headers.get("content-type")) && Ie.setContentType(de), he.body) {
          const [Mt, xt] = zr(
            Lt,
            ks(Xr(re))
          );
          S = Jr(he.body, Zr, Mt, xt);
        }
      }
      y.isString($e) || ($e = $e ? "include" : "omit");
      const K = o && "credentials" in s.prototype, q = {
        ...Ve,
        signal: et,
      ...
      if (a && (L || We && je)) {
        ...
        const de = y.toFiniteNumber(W.headers.get("content-length")), [Mt, xt] = L && zr(
          de,
          ks(Xr(L), !0)
        ) || [];
        W = new n(
      ...
      ) : D.from(K, K && K.code, m, Ye, K && K.response);
    }
  };
...
const $r = (e) => `- ${e}`, ju = (e) => y.isFunction(e) || e === null || e === !1;
function Du(e, t) {
  e = y.isArray(e) ? e : [e];
  const { length: s } = e;
  let n, r;
  ...
  for (let i = 0; i < s; i++) {
    n = e[i];
    let l;
    if (r = n, !ju(n) && (r = $n[(l = String(n)).toLowerCase()], r === void 0))
...
const {
...
}, Wu = ["failed", "cancelled", "expired", "network"], Gu = (e) => Wu.includes(e), zu = "Because you have stopped, no data has been shared.", Xu = "Stopped", Ku = "Close", Ju = "If you stop now, no data will be shared.", Zu = "Are you sure you want to stop?", Qu = "On another device", qu = "On this device", _u = "On which device is your NP Wallet app installed?", $u = "This action has been stopped because too much time has passed. This happens to keep your data safe. Please try again.", ef = "Sorry, time is over", tf = "This action was unsuccessful. This may have several reasons. Please try again.", sf = "Sorry, something went wrong", nf = "No NP Wallet App yet? Or need help?", rf = "To NP Wallet website", of = "Follow the steps in your NP Wallet app", lf = "Your request is being retrieved", af = "Please wait", cf = "NP Wallet", uf = "Need help?", ff = "Your internet connection seems to be down or too slow. Check your connection and try again.", df = "Sorry, no internet connection", hf = "No", pf = "QR code", mf = "Scan the QR code with your NP Wallet app", gf = "Try again", yf = "Stop", bf = "Close this page and continue in the new opened tab.", wf = "Success!", Af = "Login with NP Wallet", Rf = "Yes, stop", vf = {
  cancelled_body: zu,
  cancelled_title: Xu,
  close: Ku,
  confirm_stop_body: Ju,
  confirm_stop_title: Zu,
  ...
  yes_stop: Rf
}, Cf = "Omdat je bent gestopt zijn er geen gegevens gedeeld.", Ef = "Gestopt", Sf = "Sluiten", Mf = "Als je stopt worden er geen gegevens gedeeld.", xf = "Weet je zeker dat je wilt stoppen?", Tf = "Op een ander apparaat", Pf = "Op dit apparaat", If = "Op welk apparaat staat je NP Wallet app?", Of = "Deze actie is gestopt omdat er teveel tijd voorbij is gegaan. Dit is bedoeld om je gegevens veilig te houden. Probeer het opnieuw.", kf = "Sorry, de tijd is voorbij", Nf = "Deze actie is niet gelukt. Dit kan verschillende redenen hebben. Probeer het opnieuw.", jf = "Sorry, er gaat iets mis", Df = "Nog geen NP Wallet app? Of hulp nodig?", Uf = "Naar NP Wallet website", Lf = "Volg de stappen in de NP Wallet app", Bf = "De gegevens worden opgehaald", Ff = "Even geduld", Hf = "NP Wallet", Vf = "Hulp nodig?", Yf = "Je verbinding met het internet lijkt niet te werken of is te traag. Controleer je verbinding en probeer het opnieuw.", Wf = "Sorry, geen internet", Gf = "Nee", zf = "QR code", Xf = "Scan de QR-code met je NP Wallet app", Kf = "Probeer opnieuw", Jf = "Stoppen", Zf = "Sluit deze pagina en ga verder in het nieuw geopende tabblad.", Qf = "Gelukt!", qf = "Inloggen met NP Wallet", _f = "Ja, stop", $f = {
  cancelled_body: Cf,
  cancelled_title: Ef,
  close: Sf,
  ...
  setup(e, { emit: t }) {
    ...
    return (r, o) => (V(), Q("footer", null, [
      ...
      ["creating", "loading", "in-progress", "confirm-stop"].includes(e.modalState.kind) ? (V(), Q("button", {
        ...
        I("span", null, X(e.modalState.kind === "confirm-stop" ? F(s)("yes_stop") : F(s)("stop")), 1)
      ], 2)) : ue("", !0),
  ...
  setup(e) {
    ...
    return (s, n) => (V(), Q("header", null, [
      I("h1", null, X(F(t)("modal_header")), 1)
    ]));
  }
}), nd = ["href"], ji = /* @__PURE__ */ fe({
  __name: "HelpLink",
  props: {
    helpBaseUrl: {}
  },
  ...
  setup(e) {
    ...
    return (s, n) => (V(), Q(ne, null, [
      I("section", rd, [
        I("h2", od, X(F(t)("confirm_stop_title")), 1),
        I("p", null, X(F(t)("confirm_stop_body")), 1)
      ]),
      ce(ji, { helpBaseUrl: e.helpBaseUrl }, null, 8, ["helpBaseUrl"])
    ], 64));
  }
}), ld = {
  class: "buttons",
  ...
  setup(e, { emit: t }) {
    ...
    return (r, o) => (V(), Q(ne, null, [
      I("h2", null, X(F(s)("device_choice_title")), 1),
      I("section", ld, [
        I("a", {
          role: "button",
          href: e.ul.toString(),
          ...
          I("span", null, X(F(s)("device_choice_same_device")), 1)
        ], 8, ad),
        I("button", {
          type: "button",
          ...
          I("span", null, X(F(s)("device_choice_cross_device")), 1)
        ])
      ])
    ], 64));
  }
...
((e) => {
  const i = class i {
    ...
    static encodeSegments(c, a, f = 1, h = 40, g = -1, m = !0) {
      ...
      let b, A;
      for (b = f; ; b++) {
        const R = i.getNumDataCodewords(b, a) * 8, L = o.getTotalBits(c, b);
        if (L <= R) {
          A = L;
          break;
        }
      ...
      for (const R of [i.Ecc.MEDIUM, i.Ecc.QUARTILE, i.Ecc.HIGH])
        m && A <= i.getNumDataCodewords(b, R) * 8 && (a = R);
      const S = [];
      for (const R of c) {
        s(R.mode.modeBits, 4, S), s(R.numChars, R.mode.numCharCountBits(b), S);
        for (const L of R.getData())
          S.push(L);
      }
      r(S.length == A);
      const U = i.getNumDataCodewords(b, a) * 8;
      r(S.length <= U), s(0, Math.min(4, U - S.length), S), s(0, (8 - S.length % 8) % 8, S), r(S.length % 8 == 0);
      for (let R = 236; S.length < U; R ^= 253)
        s(R, 8, S);
      const T = [];
      for (; T.length * 8 < S.length; )
        T.push(0);
      return S.forEach((R, L) => T[L >>> 3] |= R << 7 - (L & 7)), new i(b, a, T, g);
    }
    /*-- Accessor methods --*/
    ...
    addEccAndInterleave(c) {
      ...
      for (let R = 0, L = 0; R < h; R++) {
        const re = c.slice(L, L + A - g + (R < b ? 0 : 1));
        L += re.length;
        const te = i.reedSolomonComputeRemainder(re, U);
        R < b && re.push(0), S.push(re.concat(te));
      }
      const T = [];
      for (let R = 0; R < S[0].length; R++)
        S.forEach((L, re) => {
          (R != A - g || re >= b) && T.push(L[R]);
        });
...
const ud = (e, t) => {
  ...
  setup(e) {
    ...
    return $t(
      ...
      I("h2", null, X(F(s)("qr_code_title")), 1),
      I("div", fd, [
        I("canvas", {
          ref_key: "canvas",
          ref: n
    ...
    return (s, n) => (V(), Q(ne, null, [
      ...
      I("section", pd, [
        e.errorType === "expired" ? (V(), Q(ne, { key: 0 }, [
          I("h2", md, X(F(t)("expired_title")), 1),
          I("p", null, X(F(t)("expired_body")), 1)
        ], 64)) : e.errorType === "failed" ? (V(), Q(ne, { key: 1 }, [
          I("h2", gd, X(F(t)("failed_title")), 1),
          I("p", null, X(F(t)("failed_body")), 1)
        ], 64)) : e.errorType === "cancelled" ? (V(), Q(ne, { key: 2 }, [
          I("h2", yd, X(F(t)("cancelled_title")), 1),
          I("p", null, X(F(t)("cancelled_body")), 1)
        ], 64)) : e.errorType === "network" ? (V(), Q(ne, { key: 3 }, [
          I("h2", bd, X(F(t)("network_title")), 1),
          I("p", null, X(F(t)("network_body")), 1)
        ], 64)) : ue("", !0)
      ]),
      ce(ji, { helpBaseUrl: e.helpBaseUrl }, null, 8, ["helpBaseUrl"])
    ], 64));
    ...
    return (r, o) => (V(), Q("section", Ad, [
      ...
      I("p", null, [
        I("a", {
          ...
          I("span", null, X(F(n)("help_to_website")), 1)
        ], 8, Rd)
      ])
    ]));
  }
}), Cd = { "data-testid": "in_progress" }, Ed = /* @__PURE__ */ fe({
  ...
  setup(e) {
    ...
    return (s, n) => (V(), Q(ne, null, [
      ...
      I("h2", Cd, X(F(t)("in_progress_title")), 1)
    ], 64));
  }
}), Di = (e, t) => {
...
const Td = /* @__PURE__ */ Di(Sd, [["render", xd]]), Pd = {
  "data-testid": "loading",
  class: "text"
}, Id = /* @__PURE__ */ fe({
  ...
  setup(e) {
    ...
    return (s, n) => (V(), Q(ne, null, [
      I("section", Pd, [
        I("h2", null, X(F(t)("loading_title")), 1),
        I("p", null, X(F(t)("loading_body")), 1)
      ]),
      ce(Td)
    ], 64));
  }
  ...
  setup(e) {
    ...
    return (s, n) => e.sessionType === "same_device" ? (V(), Q(ne, { key: 0 }, [
      ...
      I("section", Od, [
        I("h2", null, X(F(t)("success_title")), 1),
        I("p", null, X(F(t)("success_body")), 1)
      ])
    ], 64)) : (V(), Q(ne, { key: 1 }, [
      n[1] || (n[1] = I("svg", {
        class: "status",
  ...
  emits: ["choice"],
  setup(e, { emit: t }) {
    const s = t, n = vt(null), r = (o) => s("choice", o);
    return Yn(async () => setTimeout(() => n.value && n.value.focus(), 0)), (o, i) => (V(), Q(ne, null, [
      I("main", {
        ref_key: "main",
        ref: n,
        tabindex: "0"
      }, [
        ["creating", "loading"].includes(e.modalState.kind) ? (V(), Te(Id, { key: 0 })) : ue("", !0),
  ...
  setup(e, { emit: t }) {
    const s = e, n = t, r = Be(nr), o = Be(tr, !1), i = Be(sr, !1), l = vt(), u = vt({ kind: "creating" });
    $t(u, (T) => {
      switch (T.kind) {
        case "created":
        case "in-progress": {
    ...
    const c = (T) => {
      ...
      try {
        const R = await Yu(T.statusUrl, T.sessionType);
        switch (R.status) {
          case "CREATED":
            R.ul !== void 0 ? u.value = {
              kind: "created",
      ...
      switch (u.value.kind) {
        case "success":
          ...
          break;
        case "error":
          n("failed", (T = u.value.session) == null ? void 0 : T.sessionToken, (R = u.value.session) == null ? void 0 : R.sessionType);
          break;
        case "creating":
        case "loading":
          n("close");
    ...
    return Yn(async () => {
      ...
      I("aside", {
        "aria-modal": "true",
        role: "dialog",
        "aria-label": F(i) ? "18up" : F(o) ? "Business Wallet" : "NP Wallet",
  ...
  emits: ["close"],
  setup(e, { emit: t }) {
    const s = e, n = t, r = Be(nr), o = Be(tr, !1), i = Be(sr, !1), l = vt({
      kind: "created",
  ...
  setup(e, { emit: t }) {
    const s = e, n = Rs(() => s.business !== void 0 && s.business !== !1), r = Rs(() => s.over18 !== void 0 && s.over18 !== !1), o = Rs(
      () => s.text ?? so(s.lang, n.value, r.value)("wallet_button_text")
    ), i = t, l = s.usecase ? { strategy: "dynamic", usecase: s.usecase, startUrl: s.startUrl } : { strategy: "static", sameDeviceUl: s.sameDeviceUl, crossDeviceUl: s.crossDeviceUl }, u = vt(!1), c = vt(null), a = !jd(window.navigator.userAgent), f = (A, S) => {
      g(), i("success", A, S);
    }, h = (A, S) => {
      g(), i("failed", A, S);
    }, g = () => {
    ...
    zt(nr, a), zt(Ne, so(s.lang, n.value, r.value)), zt(tr, n.value), zt(sr, r.value);
...
@font-face {
  ...
  font-weight: bold;
  font-style: normal;
  src: url(data:application/font-woff2;charset=utf-8;base64,${Yd}) format('woff2');
