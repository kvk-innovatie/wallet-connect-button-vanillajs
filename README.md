...
npm install
npm run dev        # Build and start server on http://localhost:5031
```

### 2. Production Usage (CDN)
```html
<script src="https://cdn.jsdelivr.net/gh/kvk-innovatie/wallet-connect-button-vanillajs@v1.0.20/wallet-connect-button.js"></script>
